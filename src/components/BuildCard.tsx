...
export function BuildCard({
  ...
  return (
    <article className="card-hover premium-border rounded-lg bg-panel/80 p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex gap-3">
          <div className="rounded-md border border-ember/35 bg-ember/10 px-3 py-2">
          ...
          <div className="rounded-md border border-volt/35 bg-volt/10 px-3 py-2">
      ...
      <p className="mt-5 text-sm leading-6 text-slate-300">{build.explanation}</p>
      ...
      <Link href={`/champions/${champion.slug}`} className="mt-5 inline-flex text-sm font-black text-volt hover:text-white">
        View champion guide
      </Link>
    </article>
  );
